...
- **Conway Walls** — optionally fill the board with procedural, maze-like structures that regenerate on a configurable interval and force snakes to find new paths.
